// Source: Day06-Flink-高级部分 (iqbixxys9icdza0s) snippet #1
package com.bigdata.snippets;

public class iqbixxys9icdza0sSnippet001 {
    ...
    public static void demo() throws Exception {
        ...
        new LoginEvent("1", "fail", "2023-07-18 10:13:22"),
        ...
        第一个字段为用户id,第二步为登录状态，第三步为事件的时间，求：连续登录失败三次的用户有哪些？
    }
}
