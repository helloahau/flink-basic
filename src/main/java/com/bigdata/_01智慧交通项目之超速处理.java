...
public class _01智慧交通项目之超速处理 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Flink 2.x: write via inline RichSinkFunction (JdbcSink.sink() API incompatible with Flink 2.x)
        filterSource.addSink(new RichSinkFunction<CarInfo>() {
            ...
            @Override
            public void invoke(CarInfo carInfo, Context context) throws Exception {
